      ...
      <SectionAnimation delay={0.1}>
         <Box css={{mb: '$10'}}>
            ...
            >
               ...
               knowledge in the programming area to deliver quality products and
               on time, I have a great motivation to solve problems and I focus
               every day to learn something new and improving on what I am
               passionate about.
            </Text>
      ...
      <SectionAnimation delay={0.3}>
         <Box css={{mb: '$10'}}>
            ...
            <Text as={'span'} css={{textIndent: '1em', fontFamily: 'inherit'}}>
               I love to learn new things, I am passionate about technology and
               I always try to learn something new every day, I love to solve
